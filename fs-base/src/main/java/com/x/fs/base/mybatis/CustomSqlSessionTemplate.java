...
public class CustomSqlSessionTemplate extends SqlSessionTemplate {
    ...
    public SqlSessionFactory getSqlSessionFactory() {
        ...
        if (targetSqlSessionFactory != null) {
            ...
            Assert.notNull(this.targetSqlSessionFactorys, "Property 'targetSqlSessionFactorys' or 'defaultTargetSqlSessionFactory' are required not null");
            Assert.notNull(this.defaultTargetSqlSessionFactory, "Property 'defaultTargetSqlSessionFactory' or 'targetSqlSessionFactorys' are required not null");
    ...
    public PersistenceExceptionTranslator getPersistenceExceptionTranslator() {
        String dataSourceName = DataSourceContextHolder.getDataSource();
        PersistenceExceptionTranslator exceptionTranslator = this.exceptionTranslatorMap.get(DataSourceUtils.getSqlSessionFactoryName(dataSourceName));
